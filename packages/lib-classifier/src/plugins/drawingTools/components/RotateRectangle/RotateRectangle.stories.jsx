...
function setupStores() {
  try {
    ...
    const strings = {
      display_name: 'RotateRectangle workflow',
    ...
    rectangle.initialDrag({ x: 150, y: 250 })
...
export default {
  title: 'Drawing tools / Rotate Rectangle',
  component: RotateRectangle
}
