...
For the `data` array, this JSON takes the same shape as expected for the generic `ScatterPlotViewer` when multiple data series are defined.

(Note: please also see the documentation for ScatterPlotViewer, as that may more up-to-date than this doc.)
