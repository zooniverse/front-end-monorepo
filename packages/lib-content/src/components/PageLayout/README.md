...
- Has an _actual_ Zooniverse header.
  ...
  - On desktop view, displays the Zooniverse (text) logo as well.
...
- A teal Zooniverse "pseudo header".
  ...
  - On desktop view, the "psuedo header" displays the Zooniverse (text) logo.
  - On mobile view, it's just a teal stripe.
