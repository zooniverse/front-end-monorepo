...
import Meta, { Last7Days, Last30DaysHours, Last3Months, Last12MonthsHours } from './BarChart.stories'
...
describe('components > shared > BarChart', function () {
  describe('with Last7Days', function () {
    ...
    it('should have the expected aria-label', function () {
      ...
      expect(screen.getByLabelText('Bar chart of Classifications by Day from 2023-05-27 to 2023-06-02')).toBeTruthy()
    })
