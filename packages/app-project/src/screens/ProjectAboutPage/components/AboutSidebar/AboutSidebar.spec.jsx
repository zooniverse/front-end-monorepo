...
describe('Component > AboutSidebar', function () {
  ...
  it('should always render at least two links: Research and The Team', function () {
    ...
    expect(getByText('About.PageHeading.title.research')).toBeDefined()
    expect(getByText('About.PageHeading.title.team')).toBeDefined()
  })
  ...
  it('should render other links passed in the aboutNavLinks array', function () {
    ...
    expect(getByText('About.PageHeading.title.education')).toBeDefined()
    expect(getByText('About.PageHeading.title.faq')).toBeDefined()
  })
})
