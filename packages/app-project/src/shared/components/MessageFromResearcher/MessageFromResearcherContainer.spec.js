...
const SOCIALUSERNAME = 'the.zooniverse'
const SOCIALLINK = 'https://www.instagram.com/the.zooniverseTESTING/'
...
describe('Component > CompletionBarContainer', function() {
  ...
  it('should pass through a `socialLink` prop', function() {
    expect(MessageFromResearcherWrapper.prop('socialLink')).to.equal(SOCIALLINK)
  })
