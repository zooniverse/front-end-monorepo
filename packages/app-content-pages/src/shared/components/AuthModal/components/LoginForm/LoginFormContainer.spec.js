  ...
  describe('onSubmit', function () {
    ...
    it('should return feedback when passed an invalid set of credentials', async function () {
      ...
      try {
        ...
        expect(MOCK_FORMIK.setFieldError).to.have.been.calledWith('login', 'LoginForm.error')
        expect(MOCK_FORMIK.setFieldError).to.have.been.calledWith('password', 'LoginForm.error')
        expect(MOCK_FORMIK.setSubmitting).to.have.been.calledWith(false)
